const PATHS = {
  ...
  whatsapp: (
    <path d="M12 3.5c-4.7 0-8.5 3.3-8.5 7.3 0 2.2 1.2 4.2 3 5.6-.1.9-.5 2.1-1.3 3.1 1.4-.1 2.7-.6 3.8-1.3.9.3 1.9.5 3 .5 4.7 0 8.5-3.3 8.5-7.3 0-4-3.8-7.3-8.5-7.3Z" />
  ),
  mail: (
    <>
